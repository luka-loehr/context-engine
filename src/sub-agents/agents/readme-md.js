...
Examine the codebase, use statusUpdate VERY FREQUENTLY (at least 6 times during exploration, BEFORE each major activity). Finally create a comprehensive README.md file and remember to include the REQUIRED successMessage parameter when calling createFile.`;
  }
}
