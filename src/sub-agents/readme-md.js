...
8. Call statusUpdate with "Saving README.md file" before using createFile tool
...
Start by calling statusUpdate with "Scanning project files", then examine key configuration files, documentation, and source code to understand the project structure, dependencies, and development workflow. Use statusUpdate at key milestones. Finally create a comprehensive README.md file following the standard format, and remember to include the REQUIRED successMessage parameter when calling createFile.`;
  }
}
